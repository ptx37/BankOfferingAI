...
export default function EmployeePortal() {
  ...
  const TABS: { id: TabId; label: string }[] = [
    { id: 'dashboard', label: t('emp.tabDashboard') },
    { id: 'products', label: t('emp.tabProducts') },
    { id: 'customers', label: t('emp.tabCustomers') },
  ];
  ...
  return (
    <div style={{
      ...
      {/* Content */}
      <div style={{ flex: 1, padding: 20, maxWidth: 1080, width: '100%', margin: '0 auto', boxSizing: 'border-box' }}>
